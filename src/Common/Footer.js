...
function Footer() {
    ...
    return (
        <div className='footer d-flex p-2 mt-3  justify-content-between'>
            ...
            <p className='text-secondary gradient_headdng d-flex ms-3 mb-0'>varunlad5@gmail.com <i class=" mx-1 bi bi-envelope-at-fill"></i> </p>
            </div>
           
            <p style={{fontWeight:600}} className='text-secondary  myColor d-flex ms-3 mb-0'> {user.windownView === 1 && "Happy Coding" } <i class="mx-2 mb-3 bi bi-emoji-smile-fill"></i></p> 
        </div>
    )
}
