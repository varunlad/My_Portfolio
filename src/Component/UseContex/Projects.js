        ...
        <div className='container my_smooth_animation'>
            <div className='row box_shadow'>
                <h3 style={{ color: "#1ed760" }}>
                    ...
                    <img className={user.windownView === 0 && 'my_icons'} src={projectIcon} alt="project" />
                </h3>
