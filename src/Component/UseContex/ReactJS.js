...
function ReactJS() {
    ...
    const [dropdownType, setDropdownType] = useState('single'); // Default to single select
    const [isSearchEnabled, setIsSearchEnabled] = useState(false); // Default to no search
    const [isSelectAllEnabled, setIsSelectAllEnabled] = useState(false); // Default to no select all
        ...
        <div className="container my_smooth_animation">
            <div className='row box_shadow'>
                <div className='col-md-12'>
                    ...
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                        Extensive understanding and practical experience with React Hooks, including useEffect for managing side effects and component lifecycle .</p>
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                    ...
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                        Familiarity with React Router for implementing navigation and routing within single-page applications (SPAs).</p>
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                        Proficient in  integrating third-party libraries and APIs into React applications to enhance functionality and user experience.</p>
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                        Strong understanding of React best practices, code organization patterns, and design principles to ensure clean, maintainable, and scalable codebases.</p>
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                        Experience in working with UI component libraries such as  Material-UI, Ant Design, and Bootstrap for rapid prototyping and consistent UI design.</p>
                    <p className="d-flex"><span className="mx-2">&#187;</span>
                ...
                <div className='col-md-12'>
                    <div className='my_card'>
                        <div onClick={handelIsCustom} style={{ cursor: "pointer" }} className="d-flex justify-content-between w-100">
                            ...
                            <img src={icon.new_white_down_icon.src} className={isCustom && "rotate_me"} />
                        </div>
                        {isCustom &&
                            <form className="mb-3 zoom_me d-flex flex-column align-items-center">
                                <p>**Here I have made common select component which can be used as both single and multi select with the help of props, we can also add search, select all, theme color by simply passing the respective props to my custom select component.</p>
